...
$properties = $pagination->getItems();
$property_type = new PropertyType();

$link = $router->url('property_list');
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden">
                  <a href="<?= $router->url('single_property', ['id' => $property->id]) ?>"><img class="img-fluid" src="<?= $property->image ?>" alt="" /></a>
                  <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                    For Sell
                  </div>
                  <!-- $property->property_type_id -->
                  <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3">
                    <?= $property_type->getPropertyTypeById($property->property_type_id); ?>
                  </div>
                </div>
                <div class="p-4 pb-0">
                  <h5 class="text-primary mb-3"><?= Number::priceFormatter($property->price) ?></h5>
                  <a class="d-block h5 mb-2" href="<?= $router->url('single_property', ['id' => $property->id]) ?>"><?= $property->name ?></a>
                  <p>
